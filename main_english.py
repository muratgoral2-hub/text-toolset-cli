# ==============================
# Command Line Toolset (CLI)
# Purpose: Perform batch operations on text files
# Features:
# 1. Read file
# 2. Write file
# 3. File analysis (line, word, character count)
# 4. Show with line numbers
# 5. Search words in file
# 6. Find & Replace
# 7. Reverse file
# 8. Word frequency analysis
# ==============================
# Function: Get user name and print greeting
...
# ===========================================
# ADDED: Smart reading and safe writing helpers
# - Correctly reads Notepad (UTF-16/ANSI), UTF-8 BOM, UTF-8 files
# - Normalizes line endings (CRLF/CR -> LF)
# - Creates .bak backup and atomic replace when writing
# ===========================================
...
#Advanced search with regex, case, whole word, context
...
# Find a word in file and replace with another
...
# Count word frequencies in file
...
# Lists the 10 most common words
...
def menu():
    ...
    while True:
        ...
        # Function calls according to menu selections
